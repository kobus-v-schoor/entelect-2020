...
class TestEnumFuncs:
    def test_max_speed(self):
        ...
        assert max_speed(4) == Speed.INIT_SPEED.value
        assert max_speed(5) == Speed.SPEED_1.value
    ...
    def test_next_speed(self):
        ...
        assert next_speed(Speed.SPEED_3.value, 4) == Speed.INIT_SPEED.value
        assert next_speed(Speed.SPEED_1.value, 4) == Speed.INIT_SPEED.value
